...
const ReportCreate = () => {
  ...
  return (
    <div className="hero">
      <form action="#" onSubmit={(e) => submitHandler(e)} className="form_signup">
        <div className="form_input form_license_number">
            <label for="license_number">Номер лицензии*</label>
            <input value={values.licenseId} onChange={(e) => {
        ...
        <div className="form_input form_full_name">
            ...
            }} value={values.name} type="text" name="full_name" />
        </div>
        <div style={{
          display: "flex"
        ...
        <div className="form_input form_color">
            ...
            }} value={values.color} type="text" name="color" />
        </div>
        <div className="form_input calendar_info">
            <label for="date">Выберите дату:</label>
            <input value={values.date.replaceAll(".", "-")} onChange={(e) => {
              setValues({type: "change_date", date: e.target.value})
            }} type="date" id="calendar_date" name="date" />
        </div>
        <div className="form_input form_description" >
            <span >Описание</span>
            <textarea style={{
            }} value={values.description} onChange={(e) => {
              setValues({type: "change_description", description: e.target.value})
            }} className="description_text" type="text" name="description"></textarea>
        </div>
        <button className="btn btn_submit" type="submit">Отправить</button>
      </form>
    </div>
