...
const Auth = () => {
  ...
  const [email, setEmail] = useState("ksen123@gmail.com");
    ...
    <main>
        ...
        <form onSubmit={(e) => getAuth(e)} action="#" className="form_signup">
          <div className="form_input form_email">
              ...
              <input placeholder='почта' onChange={(e) => {
          ...
          <div className="form_input form_password">
              ...
              }} value={password} placeholder="пароль" type="password" name="password" required/>
          </div>
          <button style={{
            width: "100%"
          }} className="btn" type="submit">Войти</button>
        </form>
        </div>
    </main>
  )
